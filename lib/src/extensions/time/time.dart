...
/// DateTime Extensions on DateTime
extension DateTimeTimeExtension on DateTime {
  ...
  /// Returns a copy of this DateTime with the specified fields replaced with
  /// the new values.
  DateTime copyWith({
    int? year,
    int? month,
  ...
  /// Returns true if this is a weekend day
  bool get isWeekend =>
      (weekday == DateTime.saturday) || (weekday == DateTime.sunday);

  /// Returns true if this is a workday
